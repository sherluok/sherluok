...
export interface ProtocolSession {
    ...
    Console: ProtocolSession.ConsoleApi;

    Debugger: ProtocolSession.DebuggerApi;

    HeapProfiler: ProtocolSession.HeapProfilerApi;

    Profiler: ProtocolSession.ProfilerApi;

    Runtime: ProtocolSession.RuntimeApi;

    Schema: ProtocolSession.SchemaApi;

    Accessibility: ProtocolSession.AccessibilityApi;

    Animation: ProtocolSession.AnimationApi;

    Audits: ProtocolSession.AuditsApi;

    Autofill: ProtocolSession.AutofillApi;

    BackgroundService: ProtocolSession.BackgroundServiceApi;

    BluetoothEmulation: ProtocolSession.BluetoothEmulationApi;

    Browser: ProtocolSession.BrowserApi;

    CSS: ProtocolSession.CSSApi;

    CacheStorage: ProtocolSession.CacheStorageApi;

    Cast: ProtocolSession.CastApi;

    DOM: ProtocolSession.DOMApi;

    DOMDebugger: ProtocolSession.DOMDebuggerApi;

    DOMSnapshot: ProtocolSession.DOMSnapshotApi;

    DOMStorage: ProtocolSession.DOMStorageApi;

    DeviceAccess: ProtocolSession.DeviceAccessApi;

    DeviceOrientation: ProtocolSession.DeviceOrientationApi;

    Emulation: ProtocolSession.EmulationApi;

    EventBreakpoints: ProtocolSession.EventBreakpointsApi;

    Extensions: ProtocolSession.ExtensionsApi;

    FedCm: ProtocolSession.FedCmApi;

    Fetch: ProtocolSession.FetchApi;

    FileSystem: ProtocolSession.FileSystemApi;

    HeadlessExperimental: ProtocolSession.HeadlessExperimentalApi;

    IO: ProtocolSession.IOApi;

    IndexedDB: ProtocolSession.IndexedDBApi;

    Input: ProtocolSession.InputApi;

    Inspector: ProtocolSession.InspectorApi;

    LayerTree: ProtocolSession.LayerTreeApi;

    Log: ProtocolSession.LogApi;

    Media: ProtocolSession.MediaApi;

    Memory: ProtocolSession.MemoryApi;

    Network: ProtocolSession.NetworkApi;

    Overlay: ProtocolSession.OverlayApi;

    PWA: ProtocolSession.PWAApi;

    Page: ProtocolSession.PageApi;

    Performance: ProtocolSession.PerformanceApi;

    PerformanceTimeline: ProtocolSession.PerformanceTimelineApi;

    Preload: ProtocolSession.PreloadApi;

    Security: ProtocolSession.SecurityApi;

    ServiceWorker: ProtocolSession.ServiceWorkerApi;

    Storage: ProtocolSession.StorageApi;

    SystemInfo: ProtocolSession.SystemInfoApi;

    Target: ProtocolSession.TargetApi;

    Tethering: ProtocolSession.TetheringApi;

    Tracing: ProtocolSession.TracingApi;

    WebAudio: ProtocolSession.WebAudioApi;

    WebAuthn: ProtocolSession.WebAuthnApi;

}

export namespace ProtocolSession {
    ...
    export interface ConsoleApi {
         ...
         */
        messageAdded: Observable<Protocol.Console.MessageAddedEvent>;
    ...
    export interface DebuggerApi {
         ...
         */
        breakpointResolved: Observable<Protocol.Debugger.BreakpointResolvedEvent>;

        /**
         * Fired when the virtual machine stopped on breakpoint or exception or any other stop criteria.
         */
        paused: Observable<Protocol.Debugger.PausedEvent>;
         ...
         */
        scriptFailedToParse: Observable<Protocol.Debugger.ScriptFailedToParseEvent>;

        /**
         * Fired when virtual machine parses script. This event is also fired for all known and uncollected
         * scripts upon enabling debugger.
         */
        scriptParsed: Observable<Protocol.Debugger.ScriptParsedEvent>;
    ...
    export interface HeapProfilerApi {
        ...
        addHeapSnapshotChunk: Observable<Protocol.HeapProfiler.AddHeapSnapshotChunkEvent>;

        /**
         * If heap objects tracking has been started then backend may send update for one or more fragments
         */
        heapStatsUpdate: Observable<Protocol.HeapProfiler.HeapStatsUpdateEvent>;
         ...
         */
        lastSeenObjectId: Observable<Protocol.HeapProfiler.LastSeenObjectIdEvent>;

        reportHeapSnapshotProgress: Observable<Protocol.HeapProfiler.ReportHeapSnapshotProgressEvent>;

        resetProfiles: Observable<void>;
    ...
    export interface ProfilerApi {
        ...
        consoleProfileFinished: Observable<Protocol.Profiler.ConsoleProfileFinishedEvent>;

        /**
         * Sent when new profile recording is started using console.profile() call.
         */
        consoleProfileStarted: Observable<Protocol.Profiler.ConsoleProfileStartedEvent>;
         ...
         */
        preciseCoverageDeltaUpdate: Observable<Protocol.Profiler.PreciseCoverageDeltaUpdateEvent>;
    ...
    export interface RuntimeApi {
         ...
         */
        bindingCalled: Observable<Protocol.Runtime.BindingCalledEvent>;

        /**
         * Issued when console API was called.
         */
        consoleAPICalled: Observable<Protocol.Runtime.ConsoleAPICalledEvent>;

        /**
         * Issued when unhandled exception was revoked.
         */
        exceptionRevoked: Observable<Protocol.Runtime.ExceptionRevokedEvent>;

        /**
         * Issued when exception was thrown and unhandled.
         */
        exceptionThrown: Observable<Protocol.Runtime.ExceptionThrownEvent>;

        /**
         * Issued when new execution context is created.
         */
        executionContextCreated: Observable<Protocol.Runtime.ExecutionContextCreatedEvent>;

        /**
         * Issued when execution context is destroyed.
         */
        executionContextDestroyed: Observable<Protocol.Runtime.ExecutionContextDestroyedEvent>;

        /**
         * Issued when all executionContexts were cleared in browser
         */
        executionContextsCleared: Observable<void>;

        /**
         * Issued when object should be inspected (for example, as a result of inspect() command line API
         * call).
         */
        inspectRequested: Observable<Protocol.Runtime.InspectRequestedEvent>;
    ...
    export interface AccessibilityApi {
         ...
         */
        loadComplete: Observable<Protocol.Accessibility.LoadCompleteEvent>;

        /**
         * The nodesUpdated event is sent every time a previously requested node has changed the in tree.
         */
        nodesUpdated: Observable<Protocol.Accessibility.NodesUpdatedEvent>;
    ...
    export interface AnimationApi {
         ...
         */
        animationCanceled: Observable<Protocol.Animation.AnimationCanceledEvent>;

        /**
         * Event for each animation that has been created.
         */
        animationCreated: Observable<Protocol.Animation.AnimationCreatedEvent>;

        /**
         * Event for animation that has been started.
         */
        animationStarted: Observable<Protocol.Animation.AnimationStartedEvent>;

        /**
         * Event for animation that has been updated.
         */
        animationUpdated: Observable<Protocol.Animation.AnimationUpdatedEvent>;
    ...
    export interface AuditsApi {
        ...
        issueAdded: Observable<Protocol.Audits.IssueAddedEvent>;
    ...
    export interface AutofillApi {
         ...
         */
        addressFormFilled: Observable<Protocol.Autofill.AddressFormFilledEvent>;
    ...
    export interface BackgroundServiceApi {
         ...
         */
        recordingStateChanged: Observable<Protocol.BackgroundService.RecordingStateChangedEvent>;

        /**
         * Called with all existing backgroundServiceEvents when enabled, and all new
         * events afterwards if enabled and recording.
         */
        backgroundServiceEventReceived: Observable<Protocol.BackgroundService.BackgroundServiceEventReceivedEvent>;
    ...
    export interface BluetoothEmulationApi {
         ...
         * happened.
         */
        gattOperationReceived: Observable<Protocol.BluetoothEmulation.GattOperationReceivedEvent>;
         ...
         */
        characteristicOperationReceived: Observable<Protocol.BluetoothEmulation.CharacteristicOperationReceivedEvent>;
         ...
         * |type| is write.
         */
        descriptorOperationReceived: Observable<Protocol.BluetoothEmulation.DescriptorOperationReceivedEvent>;
    ...
    export interface BrowserApi {
         ...
         */
        downloadWillBegin: Observable<Protocol.Browser.DownloadWillBeginEvent>;

        /**
         * Fired when download makes progress. Last call has |done| == true.
         */
        downloadProgress: Observable<Protocol.Browser.DownloadProgressEvent>;
    ...
    export interface CSSApi {
         ...
         * web font.
         */
        fontsUpdated: Observable<Protocol.CSS.FontsUpdatedEvent>;

        /**
         * Fires whenever a MediaQuery result changes (for example, after a browser window has been
         * resized.) The current implementation considers only viewport-dependent media features.
         */
        mediaQueryResultChanged: Observable<void>;

        /**
         * Fired whenever an active document stylesheet is added.
         */
        styleSheetAdded: Observable<Protocol.CSS.StyleSheetAddedEvent>;

        /**
         * Fired whenever a stylesheet is changed as a result of the client operation.
         */
        styleSheetChanged: Observable<Protocol.CSS.StyleSheetChangedEvent>;

        /**
         * Fired whenever an active document stylesheet is removed.
         */
        styleSheetRemoved: Observable<Protocol.CSS.StyleSheetRemovedEvent>;

        computedStyleUpdated: Observable<Protocol.CSS.ComputedStyleUpdatedEvent>;
    ...
    export interface CastApi {
         ...
         */
        sinksUpdated: Observable<Protocol.Cast.SinksUpdatedEvent>;

        /**
         * This is fired whenever the outstanding issue/error message changes.
         * |issueMessage| is empty if there is no issue.
         */
        issueUpdated: Observable<Protocol.Cast.IssueUpdatedEvent>;
    ...
    export interface DOMApi {
         ...
         */
        attributeModified: Observable<Protocol.DOM.AttributeModifiedEvent>;

        /**
         * Fired when `Element`'s attribute is removed.
         */
        attributeRemoved: Observable<Protocol.DOM.AttributeRemovedEvent>;

        /**
         * Mirrors `DOMCharacterDataModified` event.
         */
        characterDataModified: Observable<Protocol.DOM.CharacterDataModifiedEvent>;

        /**
         * Fired when `Container`'s child node count has changed.
         */
        childNodeCountUpdated: Observable<Protocol.DOM.ChildNodeCountUpdatedEvent>;

        /**
         * Mirrors `DOMNodeInserted` event.
         */
        childNodeInserted: Observable<Protocol.DOM.ChildNodeInsertedEvent>;

        /**
         * Mirrors `DOMNodeRemoved` event.
         */
        childNodeRemoved: Observable<Protocol.DOM.ChildNodeRemovedEvent>;

        /**
         * Called when distribution is changed.
         */
        distributedNodesUpdated: Observable<Protocol.DOM.DistributedNodesUpdatedEvent>;
         ...
         */
        inlineStyleInvalidated: Observable<Protocol.DOM.InlineStyleInvalidatedEvent>;

        /**
         * Called when a pseudo element is added to an element.
         */
        pseudoElementAdded: Observable<Protocol.DOM.PseudoElementAddedEvent>;

        /**
         * Called when top layer elements are changed.
         */
        topLayerElementsUpdated: Observable<void>;

        /**
         * Fired when a node's scrollability state changes.
         */
        scrollableFlagUpdated: Observable<Protocol.DOM.ScrollableFlagUpdatedEvent>;

        /**
         * Fired when a node's starting styles changes.
         */
        affectedByStartingStylesFlagUpdated: Observable<Protocol.DOM.AffectedByStartingStylesFlagUpdatedEvent>;

        /**
         * Called when a pseudo element is removed from an element.
         */
        pseudoElementRemoved: Observable<Protocol.DOM.PseudoElementRemovedEvent>;

        /**
         * Fired when backend wants to provide client with the missing DOM structure. This happens upon
         * most of the calls requesting node ids.
         */
        setChildNodes: Observable<Protocol.DOM.SetChildNodesEvent>;

        /**
         * Called when shadow root is popped from the element.
         */
        shadowRootPopped: Observable<Protocol.DOM.ShadowRootPoppedEvent>;

        /**
         * Called when shadow root is pushed into the element.
         */
        shadowRootPushed: Observable<Protocol.DOM.ShadowRootPushedEvent>;
    ...
    export interface DOMStorageApi {
        ...
        domStorageItemAdded: Observable<Protocol.DOMStorage.DomStorageItemAddedEvent>;

        domStorageItemRemoved: Observable<Protocol.DOMStorage.DomStorageItemRemovedEvent>;

        domStorageItemUpdated: Observable<Protocol.DOMStorage.DomStorageItemUpdatedEvent>;

        domStorageItemsCleared: Observable<Protocol.DOMStorage.DomStorageItemsClearedEvent>;
    ...
    export interface DeviceAccessApi {
         ...
         */
        deviceRequestPrompted: Observable<Protocol.DeviceAccess.DeviceRequestPromptedEvent>;
    ...
    export interface EmulationApi {
         ...
         */
        virtualTimeBudgetExpired: Observable<void>;
    ...
    export interface FedCmApi {
        ...
        dialogShown: Observable<Protocol.FedCm.DialogShownEvent>;

        /**
         * Triggered when a dialog is closed, either by user action, JS abort,
         * or a command below.
         */
        dialogClosed: Observable<Protocol.FedCm.DialogClosedEvent>;
    ...
    export interface FetchApi {
         ...
         */
        requestPaused: Observable<Protocol.Fetch.RequestPausedEvent>;

        /**
         * Issued when the domain is enabled with handleAuthRequests set to true.
         * The request is paused until client responds with continueWithAuth.
         */
        authRequired: Observable<Protocol.Fetch.AuthRequiredEvent>;
    ...
    export interface InputApi {
         ...
         */
        dragIntercepted: Observable<Protocol.Input.DragInterceptedEvent>;
    ...
    export interface InspectorApi {
         ...
         */
        detached: Observable<Protocol.Inspector.DetachedEvent>;

        /**
         * Fired when debugging target has crashed
         */
        targetCrashed: Observable<void>;

        /**
         * Fired when debugging target has reloaded after crash
         */
        targetReloadedAfterCrash: Observable<void>;
    ...
    export interface LayerTreeApi {
        ...
        layerPainted: Observable<Protocol.LayerTree.LayerPaintedEvent>;

        layerTreeDidChange: Observable<Protocol.LayerTree.LayerTreeDidChangeEvent>;
    ...
    export interface LogApi {
         ...
         */
        entryAdded: Observable<Protocol.Log.EntryAddedEvent>;
    ...
    export interface MediaApi {
         ...
         */
        playerPropertiesChanged: Observable<Protocol.Media.PlayerPropertiesChangedEvent>;

        /**
         * Send events as a list, allowing them to be batched on the browser for less
         * congestion. If batched, events must ALWAYS be in chronological order.
         */
        playerEventsAdded: Observable<Protocol.Media.PlayerEventsAddedEvent>;

        /**
         * Send a list of any messages that need to be delivered.
         */
        playerMessagesLogged: Observable<Protocol.Media.PlayerMessagesLoggedEvent>;

        /**
         * Send a list of any errors that need to be delivered.
         */
        playerErrorsRaised: Observable<Protocol.Media.PlayerErrorsRaisedEvent>;
         ...
         */
        playerCreated: Observable<Protocol.Media.PlayerCreatedEvent>;
    ...
    export interface NetworkApi {
         ...
         */
        dataReceived: Observable<Protocol.Network.DataReceivedEvent>;

        /**
         * Fired when EventSource message is received.
         */
        eventSourceMessageReceived: Observable<Protocol.Network.EventSourceMessageReceivedEvent>;

        /**
         * Fired when HTTP request has failed to load.
         */
        loadingFailed: Observable<Protocol.Network.LoadingFailedEvent>;

        /**
         * Fired when HTTP request has finished loading.
         */
        loadingFinished: Observable<Protocol.Network.LoadingFinishedEvent>;
         ...
         */
        requestIntercepted: Observable<Protocol.Network.RequestInterceptedEvent>;

        /**
         * Fired if request ended up loading from cache.
         */
        requestServedFromCache: Observable<Protocol.Network.RequestServedFromCacheEvent>;

        /**
         * Fired when page is about to send HTTP request.
         */
        requestWillBeSent: Observable<Protocol.Network.RequestWillBeSentEvent>;

        /**
         * Fired when resource loading priority is changed
         */
        resourceChangedPriority: Observable<Protocol.Network.ResourceChangedPriorityEvent>;

        /**
         * Fired when a signed exchange was received over the network
         */
        signedExchangeReceived: Observable<Protocol.Network.SignedExchangeReceivedEvent>;

        /**
         * Fired when HTTP response is available.
         */
        responseReceived: Observable<Protocol.Network.ResponseReceivedEvent>;

        /**
         * Fired when WebSocket is closed.
         */
        webSocketClosed: Observable<Protocol.Network.WebSocketClosedEvent>;

        /**
         * Fired upon WebSocket creation.
         */
        webSocketCreated: Observable<Protocol.Network.WebSocketCreatedEvent>;

        /**
         * Fired when WebSocket message error occurs.
         */
        webSocketFrameError: Observable<Protocol.Network.WebSocketFrameErrorEvent>;

        /**
         * Fired when WebSocket message is received.
         */
        webSocketFrameReceived: Observable<Protocol.Network.WebSocketFrameReceivedEvent>;

        /**
         * Fired when WebSocket message is sent.
         */
        webSocketFrameSent: Observable<Protocol.Network.WebSocketFrameSentEvent>;

        /**
         * Fired when WebSocket handshake response becomes available.
         */
        webSocketHandshakeResponseReceived: Observable<Protocol.Network.WebSocketHandshakeResponseReceivedEvent>;

        /**
         * Fired when WebSocket is about to initiate handshake.
         */
        webSocketWillSendHandshakeRequest: Observable<Protocol.Network.WebSocketWillSendHandshakeRequestEvent>;

        /**
         * Fired upon WebTransport creation.
         */
        webTransportCreated: Observable<Protocol.Network.WebTransportCreatedEvent>;

        /**
         * Fired when WebTransport handshake is finished.
         */
        webTransportConnectionEstablished: Observable<Protocol.Network.WebTransportConnectionEstablishedEvent>;

        /**
         * Fired when WebTransport is disposed.
         */
        webTransportClosed: Observable<Protocol.Network.WebTransportClosedEvent>;

        /**
         * Fired upon direct_socket.TCPSocket creation.
         */
        directTCPSocketCreated: Observable<Protocol.Network.DirectTCPSocketCreatedEvent>;

        /**
         * Fired when direct_socket.TCPSocket connection is opened.
         */
        directTCPSocketOpened: Observable<Protocol.Network.DirectTCPSocketOpenedEvent>;

        /**
         * Fired when direct_socket.TCPSocket is aborted.
         */
        directTCPSocketAborted: Observable<Protocol.Network.DirectTCPSocketAbortedEvent>;

        /**
         * Fired when direct_socket.TCPSocket is closed.
         */
        directTCPSocketClosed: Observable<Protocol.Network.DirectTCPSocketClosedEvent>;

        /**
         * Fired when data is sent to tcp direct socket stream.
         */
        directTCPSocketChunkSent: Observable<Protocol.Network.DirectTCPSocketChunkSentEvent>;

        /**
         * Fired when data is received from tcp direct socket stream.
         */
        directTCPSocketChunkReceived: Observable<Protocol.Network.DirectTCPSocketChunkReceivedEvent>;

        /**
         * Fired upon direct_socket.UDPSocket creation.
         */
        directUDPSocketCreated: Observable<Protocol.Network.DirectUDPSocketCreatedEvent>;

        /**
         * Fired when direct_socket.UDPSocket connection is opened.
         */
        directUDPSocketOpened: Observable<Protocol.Network.DirectUDPSocketOpenedEvent>;

        /**
         * Fired when direct_socket.UDPSocket is aborted.
         */
        directUDPSocketAborted: Observable<Protocol.Network.DirectUDPSocketAbortedEvent>;

        /**
         * Fired when direct_socket.UDPSocket is closed.
         */
        directUDPSocketClosed: Observable<Protocol.Network.DirectUDPSocketClosedEvent>;

        /**
         * Fired when message is sent to udp direct socket stream.
         */
        directUDPSocketChunkSent: Observable<Protocol.Network.DirectUDPSocketChunkSentEvent>;

        /**
         * Fired when message is received from udp direct socket stream.
         */
        directUDPSocketChunkReceived: Observable<Protocol.Network.DirectUDPSocketChunkReceivedEvent>;
         ...
         */
        requestWillBeSentExtraInfo: Observable<Protocol.Network.RequestWillBeSentExtraInfoEvent>;
         ...
         */
        responseReceivedExtraInfo: Observable<Protocol.Network.ResponseReceivedExtraInfoEvent>;
         ...
         */
        responseReceivedEarlyHints: Observable<Protocol.Network.ResponseReceivedEarlyHintsEvent>;
         ...
         */
        trustTokenOperationDone: Observable<Protocol.Network.TrustTokenOperationDoneEvent>;

        /**
         * Fired once security policy has been updated.
         */
        policyUpdated: Observable<void>;

        /**
         * Fired once when parsing the .wbn file has succeeded.
         * The event contains the information about the web bundle contents.
         */
        subresourceWebBundleMetadataReceived: Observable<Protocol.Network.SubresourceWebBundleMetadataReceivedEvent>;

        /**
         * Fired once when parsing the .wbn file has failed.
         */
        subresourceWebBundleMetadataError: Observable<Protocol.Network.SubresourceWebBundleMetadataErrorEvent>;

        /**
         * Fired when handling requests for resources within a .wbn file.
         * Note: this will only be fired for resources that are requested by the webpage.
         */
        subresourceWebBundleInnerResponseParsed: Observable<Protocol.Network.SubresourceWebBundleInnerResponseParsedEvent>;

        /**
         * Fired when request for resources within a .wbn file failed.
         */
        subresourceWebBundleInnerResponseError: Observable<Protocol.Network.SubresourceWebBundleInnerResponseErrorEvent>;

        /**
         * Is sent whenever a new report is added.
         * And after 'enableReportingApi' for all existing reports.
         */
        reportingApiReportAdded: Observable<Protocol.Network.ReportingApiReportAddedEvent>;

        reportingApiReportUpdated: Observable<Protocol.Network.ReportingApiReportUpdatedEvent>;

        reportingApiEndpointsChangedForOrigin: Observable<Protocol.Network.ReportingApiEndpointsChangedForOriginEvent>;
    ...
    export interface OverlayApi {
         ...
         */
        inspectNodeRequested: Observable<Protocol.Overlay.InspectNodeRequestedEvent>;

        /**
         * Fired when the node should be highlighted. This happens after call to `setInspectMode`.
         */
        nodeHighlightRequested: Observable<Protocol.Overlay.NodeHighlightRequestedEvent>;

        /**
         * Fired when user asks to capture screenshot of some area on the page.
         */
        screenshotRequested: Observable<Protocol.Overlay.ScreenshotRequestedEvent>;

        /**
         * Fired when user cancels the inspect mode.
         */
        inspectModeCanceled: Observable<void>;
    ...
    export interface PageApi {
        ...
        domContentEventFired: Observable<Protocol.Page.DomContentEventFiredEvent>;

        /**
         * Emitted only when `page.interceptFileChooser` is enabled.
         */
        fileChooserOpened: Observable<Protocol.Page.FileChooserOpenedEvent>;

        /**
         * Fired when frame has been attached to its parent.
         */
        frameAttached: Observable<Protocol.Page.FrameAttachedEvent>;

        /**
         * Fired when frame no longer has a scheduled navigation.
         */
        frameClearedScheduledNavigation: Observable<Protocol.Page.FrameClearedScheduledNavigationEvent>;

        /**
         * Fired when frame has been detached from its parent.
         */
        frameDetached: Observable<Protocol.Page.FrameDetachedEvent>;

        /**
         * Fired before frame subtree is detached. Emitted before any frame of the
         * subtree is actually detached.
         */
        frameSubtreeWillBeDetached: Observable<Protocol.Page.FrameSubtreeWillBeDetachedEvent>;

        /**
         * Fired once navigation of the frame has completed. Frame is now associated with the new loader.
         */
        frameNavigated: Observable<Protocol.Page.FrameNavigatedEvent>;

        /**
         * Fired when opening document to write to.
         */
        documentOpened: Observable<Protocol.Page.DocumentOpenedEvent>;

        frameResized: Observable<void>;
         ...
         * frameset).
         */
        frameStartedNavigating: Observable<Protocol.Page.FrameStartedNavigatingEvent>;

        /**
         * Fired when a renderer-initiated navigation is requested.
         * Navigation may still be cancelled after the event is issued.
         */
        frameRequestedNavigation: Observable<Protocol.Page.FrameRequestedNavigationEvent>;

        /**
         * Fired when frame schedules a potential navigation.
         */
        frameScheduledNavigation: Observable<Protocol.Page.FrameScheduledNavigationEvent>;

        /**
         * Fired when frame has started loading.
         */
        frameStartedLoading: Observable<Protocol.Page.FrameStartedLoadingEvent>;

        /**
         * Fired when frame has stopped loading.
         */
        frameStoppedLoading: Observable<Protocol.Page.FrameStoppedLoadingEvent>;

        /**
         * Fired when page is about to start a download.
         * Deprecated. Use Browser.downloadWillBegin instead.
         */
        downloadWillBegin: Observable<Protocol.Page.DownloadWillBeginEvent>;

        /**
         * Fired when download makes progress. Last call has |done| == true.
         * Deprecated. Use Browser.downloadProgress instead.
         */
        downloadProgress: Observable<Protocol.Page.DownloadProgressEvent>;

        /**
         * Fired when interstitial page was hidden
         */
        interstitialHidden: Observable<void>;

        /**
         * Fired when interstitial page was shown
         */
        interstitialShown: Observable<void>;

        /**
         * Fired when a JavaScript initiated dialog (alert, confirm, prompt, or onbeforeunload) has been
         * closed.
         */
        javascriptDialogClosed: Observable<Protocol.Page.JavascriptDialogClosedEvent>;

        /**
         * Fired when a JavaScript initiated dialog (alert, confirm, prompt, or onbeforeunload) is about to
         * open.
         */
        javascriptDialogOpening: Observable<Protocol.Page.JavascriptDialogOpeningEvent>;

        /**
         * Fired for lifecycle events (navigation, load, paint, etc) in the current
         * target (including local frames).
         */
        lifecycleEvent: Observable<Protocol.Page.LifecycleEventEvent>;
         ...
         */
        backForwardCacheNotUsed: Observable<Protocol.Page.BackForwardCacheNotUsedEvent>;

        loadEventFired: Observable<Protocol.Page.LoadEventFiredEvent>;

        /**
         * Fired when same-document navigation happens, e.g. due to history API usage or anchor navigation.
         */
        navigatedWithinDocument: Observable<Protocol.Page.NavigatedWithinDocumentEvent>;

        /**
         * Compressed image data requested by the `startScreencast`.
         */
        screencastFrame: Observable<Protocol.Page.ScreencastFrameEvent>;

        /**
         * Fired when the page with currently enabled screencast was shown or hidden `.
         */
        screencastVisibilityChanged: Observable<Protocol.Page.ScreencastVisibilityChangedEvent>;

        /**
         * Fired when a new window is going to be opened, via window.open(), link click, form submission,
         * etc.
         */
        windowOpen: Observable<Protocol.Page.WindowOpenEvent>;

        /**
         * Issued for every compilation cache generated.
         */
        compilationCacheProduced: Observable<Protocol.Page.CompilationCacheProducedEvent>;
    ...
    export interface PerformanceApi {
         ...
         */
        metrics: Observable<Protocol.Performance.MetricsEvent>;
    ...
    export interface PerformanceTimelineApi {
         ...
         */
        timelineEventAdded: Observable<Protocol.PerformanceTimeline.TimelineEventAddedEvent>;
    ...
    export interface PreloadApi {
         ...
         */
        ruleSetUpdated: Observable<Protocol.Preload.RuleSetUpdatedEvent>;

        ruleSetRemoved: Observable<Protocol.Preload.RuleSetRemovedEvent>;

        /**
         * Fired when a preload enabled state is updated.
         */
        preloadEnabledStateUpdated: Observable<Protocol.Preload.PreloadEnabledStateUpdatedEvent>;

        /**
         * Fired when a prefetch attempt is updated.
         */
        prefetchStatusUpdated: Observable<Protocol.Preload.PrefetchStatusUpdatedEvent>;

        /**
         * Fired when a prerender attempt is updated.
         */
        prerenderStatusUpdated: Observable<Protocol.Preload.PrerenderStatusUpdatedEvent>;

        /**
         * Send a list of sources for all preloading attempts in a document.
         */
        preloadingAttemptSourcesUpdated: Observable<Protocol.Preload.PreloadingAttemptSourcesUpdatedEvent>;
    ...
    export interface SecurityApi {
         ...
         */
        certificateError: Observable<Protocol.Security.CertificateErrorEvent>;

        /**
         * The security state of the page changed.
         */
        visibleSecurityStateChanged: Observable<Protocol.Security.VisibleSecurityStateChangedEvent>;

        /**
         * The security state of the page changed. No longer being sent.
         */
        securityStateChanged: Observable<Protocol.Security.SecurityStateChangedEvent>;
    ...
    export interface ServiceWorkerApi {
        ...
        workerErrorReported: Observable<Protocol.ServiceWorker.WorkerErrorReportedEvent>;

        workerRegistrationUpdated: Observable<Protocol.ServiceWorker.WorkerRegistrationUpdatedEvent>;

        workerVersionUpdated: Observable<Protocol.ServiceWorker.WorkerVersionUpdatedEvent>;
    ...
    export interface StorageApi {
         ...
         */
        cacheStorageContentUpdated: Observable<Protocol.Storage.CacheStorageContentUpdatedEvent>;

        /**
         * A cache has been added/deleted.
         */
        cacheStorageListUpdated: Observable<Protocol.Storage.CacheStorageListUpdatedEvent>;

        /**
         * The origin's IndexedDB object store has been modified.
         */
        indexedDBContentUpdated: Observable<Protocol.Storage.IndexedDBContentUpdatedEvent>;

        /**
         * The origin's IndexedDB database list has been modified.
         */
        indexedDBListUpdated: Observable<Protocol.Storage.IndexedDBListUpdatedEvent>;

        /**
         * One of the interest groups was accessed. Note that these events are global
         * to all targets sharing an interest group store.
         */
        interestGroupAccessed: Observable<Protocol.Storage.InterestGroupAccessedEvent>;

        /**
         * An auction involving interest groups is taking place. These events are
         * target-specific.
         */
        interestGroupAuctionEventOccurred: Observable<Protocol.Storage.InterestGroupAuctionEventOccurredEvent>;
         ...
         * loadingFailed).
         */
        interestGroupAuctionNetworkRequestCreated: Observable<Protocol.Storage.InterestGroupAuctionNetworkRequestCreatedEvent>;

        /**
         * Shared storage was accessed by the associated page.
         * The following parameters are included in all events.
         */
        sharedStorageAccessed: Observable<Protocol.Storage.SharedStorageAccessedEvent>;

        /**
         * A shared storage run or selectURL operation finished its execution.
         * The following parameters are included in all events.
         */
        sharedStorageWorkletOperationExecutionFinished: Observable<Protocol.Storage.SharedStorageWorkletOperationExecutionFinishedEvent>;

        storageBucketCreatedOrUpdated: Observable<Protocol.Storage.StorageBucketCreatedOrUpdatedEvent>;

        storageBucketDeleted: Observable<Protocol.Storage.StorageBucketDeletedEvent>;

        attributionReportingSourceRegistered: Observable<Protocol.Storage.AttributionReportingSourceRegisteredEvent>;

        attributionReportingTriggerRegistered: Observable<Protocol.Storage.AttributionReportingTriggerRegisteredEvent>;

        attributionReportingReportSent: Observable<Protocol.Storage.AttributionReportingReportSentEvent>;

        attributionReportingVerboseDebugReportSent: Observable<Protocol.Storage.AttributionReportingVerboseDebugReportSentEvent>;
    ...
    export interface TargetApi {
         ...
         */
        attachedToTarget: Observable<Protocol.Target.AttachedToTargetEvent>;

        /**
         * Issued when detached from target for any reason (including `detachFromTarget` command). Can be
         * issued multiple times per target if multiple sessions have been attached to it.
         */
        detachedFromTarget: Observable<Protocol.Target.DetachedFromTargetEvent>;

        /**
         * Notifies about a new protocol message received from the session (as reported in
         * `attachedToTarget` event).
         */
        receivedMessageFromTarget: Observable<Protocol.Target.ReceivedMessageFromTargetEvent>;

        /**
         * Issued when a possible inspection target is created.
         */
        targetCreated: Observable<Protocol.Target.TargetCreatedEvent>;

        /**
         * Issued when a target is destroyed.
         */
        targetDestroyed: Observable<Protocol.Target.TargetDestroyedEvent>;

        /**
         * Issued when a target has crashed.
         */
        targetCrashed: Observable<Protocol.Target.TargetCrashedEvent>;

        /**
         * Issued when some information about a target has changed. This only happens between
         * `targetCreated` and `targetDestroyed`.
         */
        targetInfoChanged: Observable<Protocol.Target.TargetInfoChangedEvent>;
    ...
    export interface TetheringApi {
         ...
         */
        accepted: Observable<Protocol.Tethering.AcceptedEvent>;
    ...
    export interface TracingApi {
        ...
        bufferUsage: Observable<Protocol.Tracing.BufferUsageEvent>;

        /**
         * Contains a bucket of collected trace events. When tracing is stopped collected events will be
         * sent as a sequence of dataCollected events followed by tracingComplete event.
         */
        dataCollected: Observable<Protocol.Tracing.DataCollectedEvent>;

        /**
         * Signals that tracing is stopped and there is no trace buffers pending flush, all data were
         * delivered via dataCollected events.
         */
        tracingComplete: Observable<Protocol.Tracing.TracingCompleteEvent>;
    ...
    export interface WebAudioApi {
         ...
         */
        contextCreated: Observable<Protocol.WebAudio.ContextCreatedEvent>;

        /**
         * Notifies that an existing BaseAudioContext will be destroyed.
         */
        contextWillBeDestroyed: Observable<Protocol.WebAudio.ContextWillBeDestroyedEvent>;

        /**
         * Notifies that existing BaseAudioContext has changed some properties (id stays the same)..
         */
        contextChanged: Observable<Protocol.WebAudio.ContextChangedEvent>;

        /**
         * Notifies that the construction of an AudioListener has finished.
         */
        audioListenerCreated: Observable<Protocol.WebAudio.AudioListenerCreatedEvent>;

        /**
         * Notifies that a new AudioListener has been created.
         */
        audioListenerWillBeDestroyed: Observable<Protocol.WebAudio.AudioListenerWillBeDestroyedEvent>;

        /**
         * Notifies that a new AudioNode has been created.
         */
        audioNodeCreated: Observable<Protocol.WebAudio.AudioNodeCreatedEvent>;

        /**
         * Notifies that an existing AudioNode has been destroyed.
         */
        audioNodeWillBeDestroyed: Observable<Protocol.WebAudio.AudioNodeWillBeDestroyedEvent>;

        /**
         * Notifies that a new AudioParam has been created.
         */
        audioParamCreated: Observable<Protocol.WebAudio.AudioParamCreatedEvent>;

        /**
         * Notifies that an existing AudioParam has been destroyed.
         */
        audioParamWillBeDestroyed: Observable<Protocol.WebAudio.AudioParamWillBeDestroyedEvent>;

        /**
         * Notifies that two AudioNodes are connected.
         */
        nodesConnected: Observable<Protocol.WebAudio.NodesConnectedEvent>;

        /**
         * Notifies that AudioNodes are disconnected. The destination can be null, and it means all the outgoing connections from the source are disconnected.
         */
        nodesDisconnected: Observable<Protocol.WebAudio.NodesDisconnectedEvent>;

        /**
         * Notifies that an AudioNode is connected to an AudioParam.
         */
        nodeParamConnected: Observable<Protocol.WebAudio.NodeParamConnectedEvent>;

        /**
         * Notifies that an AudioNode is disconnected to an AudioParam.
         */
        nodeParamDisconnected: Observable<Protocol.WebAudio.NodeParamDisconnectedEvent>;
    ...
    export interface WebAuthnApi {
         ...
         */
        credentialAdded: Observable<Protocol.WebAuthn.CredentialAddedEvent>;

        /**
         * Triggered when a credential is deleted, e.g. through
         * PublicKeyCredential.signalUnknownCredential().
         */
        credentialDeleted: Observable<Protocol.WebAuthn.CredentialDeletedEvent>;

        /**
         * Triggered when a credential is updated, e.g. through
         * PublicKeyCredential.signalCurrentUserDetails().
         */
        credentialUpdated: Observable<Protocol.WebAuthn.CredentialUpdatedEvent>;

        /**
         * Triggered when a credential is used in a webauthn assertion.
         */
        credentialAsserted: Observable<Protocol.WebAuthn.CredentialAssertedEvent>;
